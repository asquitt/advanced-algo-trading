# Advanced Algo Trading - AWS Infrastructure
...
resource "aws_lb_listener" "trading_listener" {
  ...
  container_definitions = jsonencode([
    {
      ...
      logConfiguration = {
        logDriver = "awslogs"
        options = {
          "awslogs-group"         = aws_cloudwatch_log_group.trading_logs.name
...
resource "aws_ecs_service" "trading_service" {
  ...
  depends_on = [aws_lb_listener.trading_listener]
...
resource "aws_appautoscaling_target" "ecs_target" {
  ...
  resource_id        = "service/${aws_ecs_cluster.trading_cluster.name}/${aws_ecs_service.trading_service.name}"
...
output "ecs_cluster_name" {
  value = aws_ecs_cluster.trading_cluster.name
}

output "ecs_service_name" {
  value = aws_ecs_service.trading_service.name
}
